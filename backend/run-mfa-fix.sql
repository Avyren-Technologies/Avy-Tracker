...
-- First, check the current column size
...
-- Test that the column can now store longer values
-- (This is just a verification - don't worry about the actual value)
SELECT 'Column size updated successfully!' as status;
