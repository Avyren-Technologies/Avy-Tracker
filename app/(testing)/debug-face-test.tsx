    ...
    try {
      switch (step) {
        ...
        case 1:
          ...
          const FaceVerificationModal = await import('../components/FaceVerificationModal');
          console.log('✅ Modal imported successfully:', !!FaceVerificationModal.default);
          setStep(2);
          break;
        case 2:
      ...
      if (error instanceof Error) {
        ...
        Alert.alert('Error', `Step ${step + 1} failed: ${JSON.stringify(error)}`);
      }
    }
  };
      ...
      <View style={{
        ...
        {steps.map((stepName, index) => (
          <View key={index} style={{
            ...
            padding: 8,
            borderRadius: 6,
            backgroundColor: index < step ? '#d5f4e6' : 
                           index === step ? '#e8f4f8' : '#f8f9fa',
          }}>
      ...
      {showModal && (
        <View style={{
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 14, textAlign: 'center', marginBottom: 20, color: '#7f8c8d' }}>
