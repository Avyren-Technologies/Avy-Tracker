    ...
    >
      <ScrollView className="flex-1 p-4">
        ...
        <View className="mb-6">
          ...
          >
            Testing Requirements 6.3 & 6.4: Real-time feedback and progress
            indicators
          </Text>
        ...
        >
          ...
          <Text style={{ color: currentColors.text }} className="text-sm mb-2">
        ...
        <View className="mb-4">
          ...
          <FaceDetectionQualityFeedback
            ...
            onQualityChange={(score: number) =>
              console.log("Quality changed:", score)
            }
          />
        </View>
