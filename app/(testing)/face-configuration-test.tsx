  ...
  const testScenarios: TestScenario[] = [
    {
      ...
      description:
        "Test that OTP verification is required before accessing face settings",
      action: () => {
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            ...
            const allTests = testScenarios.reduce(
              (acc, scenario) => {
      ...
      >
        ...
        >
          <View style={styles.testsHeader}>
            ...
            <Text style={[styles.testsTitle, { color: textColor }]}>
              Test Scenarios
            </Text>
          </View>
          ...
          {testScenarios.map((scenario) => (
            ...
            >
              ...
              <Text
                style={[styles.testDescription, { color: secondaryTextColor }]}
              >
        ...
        >
          ...
          <View style={styles.instructionsList}>
            <Text
              style={[styles.instructionItem, { color: secondaryTextColor }]}
            >
