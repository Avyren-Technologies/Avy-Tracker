      ...
      >
        ...
        <View className="mt-6 p-4 rounded-lg bg-yellow-50">
          <Text className="text-yellow-800 text-sm">
            Security Note: As a super admin, your password is crucial for system
            security. Make sure to use a strong, unique password and never share
            it with anyone. Consider using a password manager for secure
            storage.
          </Text>
        </View>
      </ScrollView>
