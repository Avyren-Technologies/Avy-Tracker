...
export default function CustomModal({
  ...
  if (fullscreen) {
    ...
    const iconBgOpacity = isDark
      ? modalConfig.bgOpacity
      : modalConfig.lightBgOpacity;
                ...
                <View className="absolute -top-12 left-1/2 z-10 transform -translate-x-1/2">
                  <Animated.View
                    className={`
                      p-3 rounded-full
                      ${
                        type === "SUCCESS" || type === "PASSWORD_CHANGE"
                          ? isDark
                            ? "bg-green-700"
                            : "bg-green-500"
                          : type === "ERROR"
                    ...
                    {onCancel && (
                      <TouchableOpacity
                        className={`
                          ...
                          ${
                            isDark
                              ? "bg-gray-700 active:bg-gray-600 border-gray-600"
                            ...
                            type === "SUCCESS" || type === "PASSWORD_CHANGE"
                              ...
                              : type === "ERROR"
                                ...
                                : type === "WARNING"
                                  ...
                                  : type === "INFO"
                                    ? isDark
                                      ? "bg-blue-700 active:bg-blue-600"
