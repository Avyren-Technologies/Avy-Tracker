  ...
  const handleSubmit = async () => {
    try {
      ...
      minStartDate.setDate(
        minStartDate.getDate() + selectedLeaveType.notice_period_days,
      );
      ...
      if (errorMessage) {
        switch (true) {
          ...
          case errorMessage.includes(
            "No active leave types found for your company",
          ): {
            errorTitle = "Leave Types Not Configured";
            userFriendlyMessage =
              "No active leave types have been configured for your company.\n\n" +
          ...
          case errorMessage.includes("leave type is not available"): {
            ...
            userFriendlyMessage =
              "The selected leave type is not available for your company.\n\n" +
          ...
          case errorMessage.includes("User gender information is required"): {
            ...
            userFriendlyMessage =
              "This leave type requires gender information.\n\n" +
          ...
          case errorMessage.includes("only available for"): {
            ...
            userFriendlyMessage =
              errorDetails || "You are not eligible for this type of leave.";
            errorType = "warning";
            break;
          }
          ...
          case errorMessage.includes("Documentation is required"): {
            ...
            userFriendlyMessage =
              "Please attach the required documentation for this leave type.";
            errorType = "warning";
            break;
          }
          ...
          case errorMessage.includes("Failed to initialize leave balance"): {
            ...
            userFriendlyMessage =
              "There was an issue initializing your leave balances.\n\n" +
    ...
    <View className="flex-1">
          ...
          <View>
            {requests.map((request, index) => (
              <React.Fragment key={request.id}>
                ...
                {index < requests.length - 1 && <View className="h-4 w-full" />}
              </React.Fragment>
            ))}
          </View>
        )}
      ...
      >
        <View className="flex-1 justify-center items-center bg-black/50">
          <View
            className={`w-11/12 max-h-[80%] rounded-2xl ${isDark ? "bg-gray-800" : "bg-white"}`}
          >
            ...
            <ScrollView className="p-6">
              <View className="space-y-4">
                ...
                {leaveTypes.find(
                  (type) => type.id.toString() === formData.leave_type_id,
