    ...
    items: [
      {
        ...
        answer:
          "Navigate to the Expense Approval Page in your admin dashboard.",
        subPoints: [
      ...
      },
      {
        ...
        answer:
          "Reject the expense and include a comment asking the employee to re-submit with the required receipt.",
      },
      {
    ...
    items: [
      {
        ...
        answer:
          "If you encounter technical issues, contact the support team via email at support@avyrentechnologies.com or call +91-9876543210.",
      },
      {
        question: "Policy or Compliance Queries",
        answer:
          "For questions about company expense policies, contact the HR or Finance team directly.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "Access step-by-step tutorials and video guides in the Admin Resources section.",
      },
      {
        question: "Policy Handbook",
        answer:
          "Refer to the Expense Policy Handbook for detailed information on approval criteria.",
      },
    ],
  },
];
