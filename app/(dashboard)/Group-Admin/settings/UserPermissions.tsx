...
export default function UserPermissions() {
  ...
  const [permissions] = useState<Permission[]>([
    ...
    },
    {
      ...
      description: "Access to team reports",
      enabled: true,
    },
    {
      id: "3",
      name: "Manage Shifts",
      description: "Can modify team shifts",
      enabled: false,
    },
  ]);
  ...
  useEffect(() => {
    if (params.updatedRoleId && params.enabledPermissions) {
      const enabledPermissions = JSON.parse(
        params.enabledPermissions as string,
      );
  ...
  const updateTrackingPermission = async (
    userId: number,
    field: TrackingField,
              ...
              {permissions.map((permission) => (
                ...
                >
                  <View className="flex-row items-center flex-1">
                    <Ionicons
                      name={
                        role.activePermissions?.includes(permission.id)
                          ? "checkmark-circle"
                          : "close-circle"
                      }
                      size={20}
