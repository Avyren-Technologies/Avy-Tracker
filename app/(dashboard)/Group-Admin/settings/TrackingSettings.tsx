      ...
      items: [
        {
          ...
          description:
            "Optimize battery usage by reducing updates when stationary",
      ...
      <View style={styles.container}>
        ...
        >
          {error && (
            ...
            >
              <Text style={{ color: theme === "dark" ? "#FFFFFF" : "#B91C1C" }}>
                {error}
              </Text>
            </View>
          )}
                  ...
                  {(["low", "medium", "high"] as const).map((precision) => (
                    <TouchableOpacity
                      ...
                      style={{
                        ...
                        alignItems: "center",
                        backgroundColor:
                          trackingSettings.default_tracking_precision ===
                          precision
                            ? "#3B82F6"
                            : theme === "dark"
                              ? "#374151"
                ...
                >
                  <View className="flex-row items-center justify-between">
                    <View className="flex-row items-center flex-1">
                      ...
                      >
                        <Ionicons
                          ...
                          color={
                            Boolean(
                              trackingSettings[
                                item.key as keyof TrackingSettings
                              ],
                            )
                              ? "#3B82F6"
                              : theme === "dark"
                      ...
                      <Switch
                        value={Boolean(
                          trackingSettings[item.key as keyof TrackingSettings],
                        )}
                        onValueChange={(value) =>
                          handleSettingChange(
                            item.key as keyof TrackingSettings,
