...
export default function EmployeeSchedule() {
  ...
  const handleAddSchedule = async (scheduleData: {
    ...
    try {
      ...
      setSchedule((prev) => ({
        ...prev,
        [scheduleData.date]: [...(prev[scheduleData.date] || []), newEvent],
      }));
      ...
      <View className="flex-row justify-between items-start">
        <View className="flex-1">
          ...
          <View className="flex-row items-center mt-2">
            ...
            />
            <Text
              className={`ml-1 ${isDark ? "text-gray-400" : "text-gray-600"}`}
            >
              {event.time}
            </Text>
            {event.location && (
  ...
  return (
    <View className={`flex-1 ${isDark ? "bg-gray-900" : "bg-gray-50"}`}>
      ...
      <ScrollView className="flex-1">
        ...
        <View
          className={`mx-4 mt-4 rounded-lg overflow-hidden ${isDark ? "bg-gray-800" : "bg-white"}`}
                ...
                <View className="p-4">
                  ...
                  <View className="flex-row items-center mt-3">
                    ...
                    {event.location && (
                      <>
                        <Text
                          className={`mx-2 ${isDark ? "text-gray-400" : "text-gray-600"}`}
                        >
                          •
                        </Text>
                        <Ionicons
      ...
      >
        ...
        <Text className="text-white font-medium ml-2">Add Schedule</Text>
      </TouchableOpacity>
