...
export default function LeaveApprovalList() {
  ...
  const [selectedRequest, setSelectedRequest] = useState<LeaveApproval | null>(
    null,
  );
  ...
  return (
    <ScrollView className="flex-1">
      <View className="p-4">
        {/* Search Bar */}
        <View
          className={`mb-4 flex-row items-center p-2 rounded-lg ${
        ...
        {/* Summary Card */}
        <View
          className={`mb-6 p-4 rounded-lg ${isDark ? "bg-gray-800" : "bg-white"}`}
        >
          <Text
            ...
            >
              ...
              <View className="p-4">
                ...
                <View className="mb-4">
                  ...
                  <Text
                    className={`mt-1 ${isDark ? "text-white" : "text-gray-900"}`}
                  >
                    {approval.reason}
                  </Text>
                </View>
      ...
      >
        <View
          className={`p-4 rounded-t-3xl ${isDark ? "bg-gray-900" : "bg-gray-50"}`}
        >
          ...
          <View className="flex-row space-x-2">
            <TouchableOpacity
              onPress={() =>
                handleAction(selectedRequest!.request_id, "approve")
              }
            ...
            <TouchableOpacity
              onPress={() =>
                handleAction(selectedRequest!.request_id, "reject")
              }
              disabled={processingAction}
              className={`flex-1 p-3 rounded-lg ${
                processingAction
