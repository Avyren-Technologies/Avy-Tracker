...
class PermissionsManager {
  ...
  static async havePermissionsBeenRequested(): Promise<boolean> {
    try {
      ...
      console.error(
        "Error checking if permissions have been requested:",
        error,
      );
      return false;
    }
   ...
   */
  static async checkLocationPermissions(): Promise<
    "granted" | "denied" | "undetermined"
  > {
    try {
   ...
   */
  static async checkBackgroundLocationPermissions(): Promise<
    "granted" | "denied" | "undetermined"
  > {
    try {
   ...
   */
  static async requestBackgroundLocationPermissions(): Promise<
    "granted" | "denied"
  > {
    try {
  ...
  static async shouldRequestFromSettings(
    ...
    try {
      ...
      console.error(
        `Error checking if ${permissionType} should be requested from settings:`,
        error,
      );
      return false;
    }
