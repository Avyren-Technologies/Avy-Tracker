...
export function NotificationProvider({
  ...
  const updateUnreadCount = async () => {
    try {
      ...
      await AsyncStorage.setItem(
        `${user.id}_unread_count`,
        JSON.stringify(currentUnreadCount),
      );
    } catch (error) {
      console.error(
        "[NotificationContext] Error updating unread count:",
        error,
      );
    }
  };
  ...
  const incrementUnreadCount = async () => {
    try {
      ...
      console.error(
        "[NotificationContext] Error incrementing unread count:",
        error,
      );
    }
  };
  ...
  const decrementUnreadCount = async () => {
    try {
      ...
      console.error(
        "[NotificationContext] Error decrementing unread count:",
        error,
      );
    }
  };
  ...
  const resetUnreadCount = async () => {
    try {
      ...
      console.error(
        "[NotificationContext] Error resetting unread count:",
        error,
      );
    }
  };
