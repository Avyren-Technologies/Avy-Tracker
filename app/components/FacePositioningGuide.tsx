...
export default function FacePositioningGuide({
   ...
   */
  const getColorForSeverity = useCallback(
    (severity: string) => {
      switch (severity) {
        case "success":
          return successColor;
                ...
                <View
                  style={[
                    styles.qualityFill,
                    {
                      ...
                      backgroundColor:
                        faceQuality.size > 0.5 ? successColor : warningColor,
                    },
                  ]}
                />
              </View>
                ...
                <View
                  style={[
                    styles.qualityFill,
                    {
                      ...
                      backgroundColor:
                        faceQuality.angle > 0.5 ? successColor : warningColor,
                    },
                  ]}
                />
              </View>
