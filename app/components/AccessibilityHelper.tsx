...
export default function AccessibilityHelper({
  ...
  const accessibilityFeatures: AccessibilityFeature[] = [
    {
      ...
      description:
        "Provides spoken instructions and feedback during face verification process.",
      icon: "volume-high",
      category: "audio",
      importance: "high",
    },
    {
      ...
      description:
        "Uses vibration patterns to provide tactile feedback for different events.",
      icon: "phone-portrait",
      category: "motor",
      importance: "high",
    },
    {
      ...
      description:
        "Increases color contrast for better visibility of interface elements.",
      icon: "contrast",
      category: "visual",
      importance: "high",
    },
    {
      ...
      title: "Large Text",
      description:
        "Increases text size throughout the interface for better readability.",
      icon: "text",
      category: "visual",
      importance: "medium",
    },
    {
      ...
      description:
        "Reduces animation speed to make interface changes easier to follow.",
      icon: "speedometer",
      category: "cognitive",
      importance: "medium",
    },
    {
      ...
      description:
        "Optimizes interface for screen readers like VoiceOver and TalkBack.",
      icon: "accessibility",
      category: "visual",
      importance: "high",
    },
    {
      ...
      description:
        "Provides detailed audio descriptions of visual elements and actions.",
  ...
  const updateSetting = useCallback(
    (key: keyof AccessibilitySettings, value: boolean) => {
      ...
      announceToScreenReader(
        `${accessibilityFeatures.find((f) => f.id === key)?.title} ${value ? "enabled" : "disabled"}`,
      );
    },
    [
      settings,
  ...
  const testFeature = useCallback(
    async (featureId: keyof AccessibilitySettings) => {
      ...
      switch (featureId) {
        case "voiceGuidance":
          await speakText(
            "Voice guidance is working correctly. You will hear spoken instructions during face verification.",
          );
          break;
        case "hapticFeedback":
        ...
        case "audioDescriptions":
          await speakText(
            "Audio descriptions provide detailed information about visual elements. For example, the face detection frame is now showing a green border indicating good positioning.",
          );
          break;
        default:
  ...
  useEffect(() => {
    if (visible) {
      announceToScreenReader(
        "Accessibility settings opened. Configure features to improve your face verification experience.",
      );
    }
      ...
      <View style={[styles.container, { backgroundColor }]}>
        ...
        >
          {getFeaturesByCategory(selectedCategory).map((feature) => (
            <View
              key={feature.id}
              style={[styles.featureItem, { borderColor: "rgba(0,0,0,0.1)" }]}
            >
