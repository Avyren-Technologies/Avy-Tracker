...
export default function TroubleshootingGuide({
  ...
  const troubleshootingItems: TroubleshootingItem[] = [
      ...
      solutions: [
        {
          ...
          description:
            "Center your face in the camera frame and ensure you're at arm's length from the device.",
          icon: "move",
          difficulty: "easy",
        ...
        },
        {
          ...
          description:
            "Move to a well-lit area or turn on additional lights. Face a window or light source.",
          icon: "sunny",
          difficulty: "easy",
        ...
        },
        {
          ...
          description:
            "Remove glasses, hats, or anything covering your face. Tie back long hair if needed.",
          icon: "eye",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          ...
          description:
            "Wipe the camera lens with a soft cloth to remove smudges or dirt.",
          icon: "camera",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
      ...
      solutions: [
        {
          ...
          description:
            "Move to a location with bright, even lighting. Natural daylight works best.",
          icon: "sunny",
          difficulty: "easy",
          estimatedTime: "1 minute",
        },
        {
          step: "Turn on lights",
          description:
            "Turn on all available room lights. Use multiple light sources for even illumination.",
          icon: "bulb",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          ...
          description:
            "Don't stand in front of windows or bright lights. Face the light source instead.",
          icon: "contrast",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          ...
          description:
            "As a last resort, ask someone to shine a phone flashlight on your face from the side.",
          icon: "flashlight",
          difficulty: "medium",
          estimatedTime: "1 minute",
        },
      ...
      solutions: [
        {
          step: "Clear the area",
          description:
            "Ensure you're alone in the camera frame. Ask others to step away.",
          icon: "person",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          ...
          description:
            "Look for mirrors or reflective surfaces that might show your face multiple times.",
          icon: "copy",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          ...
          description:
            "Change the camera angle to avoid capturing other people or reflections.",
          icon: "camera-reverse",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
    ...
    },
    {
      ...
      description:
        "The system couldn't detect natural eye movement or blinking.",
      icon: "eye-off",
      category: "common",
      ...
      solutions: [
        {
          ...
          description:
            "When prompted, blink your eyes naturally. Don't force or exaggerate the movement.",
          icon: "eye",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          step: "Keep eyes open",
          description:
            "Keep your eyes open most of the time. Only blink when specifically asked.",
          icon: "eye",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          step: "Stay still",
          description:
            "Keep your head and body still during liveness detection. Only move your eyes.",
          icon: "pause",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          step: "Remove glasses",
          description:
            "If wearing glasses, try removing them as they can interfere with eye detection.",
          icon: "glasses",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
      ...
      solutions: [
        {
          ...
          description:
            "Go to your device settings and ensure the app has camera permission enabled.",
          icon: "settings",
          difficulty: "medium",
        ...
        },
        {
          ...
          description:
            "Close and reopen the app to trigger the permission request again.",
          icon: "refresh",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          ...
          description:
            "Ensure camera access isn't restricted by parental controls or device policies.",
          icon: "shield",
          difficulty: "advanced",
      ...
      solutions: [
        {
          ...
          description:
            "Ensure you have a stable internet connection. Try opening a web page.",
          icon: "wifi",
          difficulty: "easy",
          estimatedTime: "1 minute",
        },
        {
          ...
          description:
            "Try switching between WiFi and mobile data to see if one works better.",
        ...
        },
        {
          ...
          description:
            "Turn airplane mode on and off, or restart your WiFi connection.",
          icon: "airplane",
          difficulty: "medium",
          estimatedTime: "2 minutes",
        },
        {
          ...
          description:
            "The server might be temporarily unavailable. Wait a few minutes and try again.",
          icon: "time",
          difficulty: "easy",
          estimatedTime: "5 minutes",
        },
      ...
      solutions: [
        {
          ...
          description:
            "Ensure optimal lighting and positioning, similar to your registration.",
        ...
        },
        {
          ...
          description:
            "Try to look similar to when you registered (same glasses, hairstyle, etc.).",
          icon: "person",
          difficulty: "easy",
          estimatedTime: "1 minute",
        },
        {
          ...
          description:
            "If problems persist, consider re-registering your face profile.",
          icon: "refresh",
          difficulty: "medium",
      ...
      solutions: [
        {
          ...
          description:
            "Close other running apps to free up memory and processing power.",
          icon: "apps",
          difficulty: "easy",
          estimatedTime: "1 minute",
        },
        {
          step: "Restart the app",
          description:
            "Force close and reopen the app to clear any temporary issues.",
          icon: "refresh",
          difficulty: "easy",
          estimatedTime: "30 seconds",
        },
        {
          step: "Restart device",
          description:
            "Restart your device to clear memory and refresh system resources.",
          icon: "power",
          difficulty: "medium",
          estimatedTime: "2 minutes",
        },
        {
          step: "Update the app",
          description:
            "Check for app updates that might include performance improvements.",
          icon: "download",
          difficulty: "medium",
          estimatedTime: "3 minutes",
        },
  ...
  const selectCategory = useCallback(
    (categoryId: string) => {
      ...
      announceToScreenReader(
        `Selected ${categories.find((c) => c.id === categoryId)?.name} category`,
      );
    },
  ...
  const toggleItem = useCallback(
    (itemId: string) => {
      ...
      if (newExpanded) {
        ...
        if (item) {
          announceToScreenReader(
            `Expanded ${item.title} troubleshooting guide`,
          );
        }
      }
    },
  ...
  const filteredItems = troubleshootingItems.filter((item) => {
    ...
    const matchesError =
      !initialError || item.relatedErrors?.includes(initialError);
            ...
            {categories.map((category) => (
              ...
              >
                <Ionicons
                  ...
                  size={20}
                  color={
                    selectedCategory === category.id ? "#ffffff" : primaryColor
                  }
                />
                <Text
                  style={[
            ...
            <View key={item.id} style={styles.itemContainer}>
              ...
              >
                <View style={styles.itemHeaderContent}>
                  <View
                    style={[styles.itemIcon, { backgroundColor: primaryColor }]}
                  >
                    ...
                    <View key={index} style={styles.solutionItem}>
                      <View style={styles.solutionHeader}>
                        ...
                        <View style={styles.solutionHeaderText}>
                          <Text
                            style={[styles.solutionStep, { color: textColor }]}
                          >
